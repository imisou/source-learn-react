...
/**
 * 根据当前的 fiebr.mode 和 executionContext 判断是否是Render阶段的更新
 * @param {*} fiber
 * @returns
 */
...
/**
 * 捕获 workLoop 阶段组件渲染执行阶段产生的错误
 *  - 处理 React.lazy() 与 Suspense 组件的状态切换
 *  - 处理 正常的错误捕获
 * @param {*} root
 * @param {*} thrownValue
 * @returns
...
/**
 *  1. 将 workInProgressRootExitStatus 标记为 RootErrored
 *  2. 将 error 推入 workInProgressRootConcurrentErrors 中
 */
